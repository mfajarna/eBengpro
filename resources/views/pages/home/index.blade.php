...
<section class="h-full w-full border-box transition-all duration-500 linear" style="background-color: #ffffff">
    <div style="font-family: 'Poppins', sans-serif">
        ...
        <div>
            ...
            <p class="mb-8 leading-relaxed font-semibold text-sm" style="color: #142850">
                        Laboratorium Bengkel Pemograman
                    </p>

                    <h1 class="lg:block hidden title-font sm:text-5xl lg:text-6xl text-4xl mb-8 font-semibold sm:leading-tight" style="color: #142850; line-height: 1.2">
                        Selamat Datang <br/>
                        Di Website Laboratorium Bengkel Pemograman 
                    </h1>
                    ...
                    <div class="inline-block items-center mx-auto lg:mx-0 lg:flex justify-center lg:space-x-8 md:space-x-2 sm:space-x-3 space-x-0">
                        ...
                        <button class="inline-flex font-semibold text-white text-base py-4 px-6 rounded-xl mb-4 lg:mb-0 md:mb-0 focus:outline-none box-shadow-header-2-3" style="background: #385da8; font-family: 'Poppins', sans-serif;">
                            Download Modul
                        </button>

                        <button class="btn-outline-header-2-3 font-normal text-black text-base py-4 px-6 rounded-xl focus:outline-none bg-transparent rounded hover:border" style="font-family: 'Poppins', sans-serif">
